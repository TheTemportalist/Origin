...
object Rendering {
	...
	def drawSprite(x: Double, y: Double, z: Double, sprite: TextureAtlasSprite, w: Double,
		...
		TessRenderer.getRenderer.pos(x + 0, y + h, z).tex(sprite.getMinU, sprite.getMaxV).endVertex()
		TessRenderer.getRenderer.pos(x + w, y + h, z).tex(sprite.getMaxU, sprite.getMaxV).endVertex()
		TessRenderer.getRenderer.pos(x + w, y + 0, z).tex(sprite.getMaxU, sprite.getMinV).endVertex()
		TessRenderer.getRenderer.pos(x + 0, y + 0, z).tex(sprite.getMinU, sprite.getMinV).endVertex()
		TessRenderer.draw()
	}
